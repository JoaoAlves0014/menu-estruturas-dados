...
namespace implementacao_de_menu_interativo
{
    internal class Fila
    {
        ...
        public static void SubMenuFila()
        {
            int escolha;
            while (true)
            {
                Console.Clear();
                Console.WriteLine("Submenu de Fila:");
        ...
        private static void InserirElemento()
        {
            ...
            Console.WriteLine($"Elemento {elemento} inserido na fila.");
        }
        ...
        private static void RemoverElemento()
        {
            if (fila.Count > 0)
            {
                ...
                Console.WriteLine($"Elemento {elemento} removido da fila.");
            }
            else
            {
        ...
        private static void ConsultarElemento()
        {
            ...
            if (fila.Contains(elemento))
                Console.WriteLine($"Elemento {elemento} encontrado na fila.");
            else
